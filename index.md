...
| `method/judging-a-tool.md` | Lineage, posture, health, grip, why and licence: what each question asks of a tool, who answers it, and the schema a lever entry fills — separated from the register itself on 2026-09-10 because judging a tool and looking one up are different acts and only one of them needs the other page | User Researcher, Product Owner, Software Architect | 2026-09-10 |
