...
| `method/agent-kanban-git-board.md` | Three findings from a live corner of the ecosystem (GitHub's own Issues/Projects agent integration, Hermes Kanban's multi-agent dispatcher, and Shipward's fix for the self-report problem): a third independent corroboration of this skill's oracle rule, and four concrete mechanisms this estate's Wekan+Forgejo setup does not have | Product Owner, Software Architect, Agile Auditor, the whole room | 2026-09-23 |
